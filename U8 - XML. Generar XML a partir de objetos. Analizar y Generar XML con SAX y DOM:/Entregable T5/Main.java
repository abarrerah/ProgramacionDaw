...
public class Main {
  public static void main(String[] args) {
    ...
    nPlayers=Arrays.asList(json);

    ArrayList <String> posRamos=new ArrayList<>();
    for(int i = 0; i <players.size() ; i++) {
        if (players.get(i).getNombre()=="Ramos"){

        posRamos.add(String.valueOf(players.get(i).getPosition()));
    }
    }
    System.out.println("El jugador Ramos tiene las posiciones: "+posRamos);
  }
